 /*
 * ESP32forth v7.0.3
 * Revision: 00e0a3633180e10fd429258aa9b704affc5f8c1c
 */
...
//   Adafruit BusIO
 ...
 // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
 #define  ENABLE_TOFVL53L0X 
 
#ifdef ENABLE_TOFVL53L0X 
...
# define OPTIONAL_WIFI_SUPPORT \
 ...
 // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//  I can put the routines here outside the other definitions
//  and it will work ok , or else I Put them together with the OLED
//  display vocabulary below and it also will work, other places
//  does not work
//  Y(readlaser, PUSH readVL53L0X()) \
//  X("readlaser", READ_LASER, PUSH readVL53L0X()) \
 // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
# define OPTIONAL_OLED_SUPPORT \
 ...
 // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
 // THIS WAS MY DIFF TESTs
//  Y(readlaser, readVL53L0X(); DROP)  
//  X("readlaser", READ_LASER, n0= readVL53L0X()) 
//  Y(Readlaser, PUSH new readVL53L0X())   
//  X("readlaser", READ_LASER, PUSH readVL53L0X()) \  
//  X("readlaser", READ_LASER, PUSH new readVL53L0X()) 
//  Y(esp_camera_sensor_get, PUSH esp_camera_sensor_get())
 // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
"\n"
"( Setup entry )\n"
": ok   .\" ESP32forth v7.0.3 - rev 00e0a3633180e10fd429258aa9b704affc5f8c1c\" cr prompt refill drop quit ;\n"
...
void setup() {
  ...
  Adafruit_VL53L0X lox = Adafruit_VL53L0X();
// ________________________ laser ____________________________________
